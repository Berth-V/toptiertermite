  ...
  return (
    <div className='services'>
            ...
            <div className='services__container2'>
              <div className='services__text__box text__box--a'>
                <p className='services__p'>
                  ...
                  findings, we’ll develop a detailed termite protection plan
      ...
      >
        <div className='services__background__filter'>
          <div className='services__container'>
            <h2 className='services__h2'>Structural Fumigation</h2>
            <div className='services__container2'>
            ...
            <div className='services__container2'>
              ...
              <div className='services__text__box text__box--b'>
                <p className='services__p'>
                  ...
                  team is well-versed in these requirements and can help ensure
                  that your escrow inspection meets all necessary standards. We
                  provide a Separated Wood-Destroying Organisms (WDO) report
                  (Sections 1 and 2) that will be faxed or e-mail immediately to
                  the escrow company, owner, and Realtor, and followed up with a
                  hard copy in the mail. We can also provide a termite clearance
                  upon completion of the termite treatment (if any) and any
                  necessary corrective wood repairs. The cost of our services is
                  billed to the escrow company. The buyer has a three-year
